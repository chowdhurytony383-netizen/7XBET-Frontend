...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="page-stack admin-page">
      <PageHeader eyebrow="Admin panel" title="Overview" description="Control users, deposits, withdrawals and important account records through backend admin routes." actions={<button className="btn btn-soft" onClick={load}><RefreshCw size={18} /> Refresh</button>} />
